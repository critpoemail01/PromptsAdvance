...
Usa o código existente e referências públicas apenas como princípios. Não copies marcas, assets ou trade dress, não inventes métricas/claims e não redesenhes toda a aplicação. Mantém backend e permissões existentes. Regista baseline, padrões adotados, estados, mobile, acessibilidade, crítica estruturada e tudo o que não conseguires validar. Não faças commit.
