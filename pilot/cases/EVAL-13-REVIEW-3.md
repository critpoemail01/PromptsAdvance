# EVAL-13 — revisão final independente 3
...
alterar a worktree. Issuer/builder não autorizado ou attestation de outro
commit produz `NO-GO`. Entrega findings e decisão apenas para esta identidade.
