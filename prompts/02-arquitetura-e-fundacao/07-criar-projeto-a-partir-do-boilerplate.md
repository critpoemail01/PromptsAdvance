...
- O `AGENTS.md` aplicável referencia `EXECUTION_CONTRACT.md`,
  `UPSTREAM_LEARNING.md` e `PRODUCT_EXCELLENCE.md` e, quando aplicável,
  `HELP_AND_ACADEMY.md`, sem
  duplicar os protocolos.
- `PROCESS_MANIFEST.json`, `QUALITY_GATES.md`, `UPSTREAM_LEARNING.md`, `PRODUCT_DEFINITION.md`, `PRODUCT_QUALITY_BASELINE.md`, `REQUIREMENTS_ENGINEERING_CONTRACT.md`, `VISUAL_SLICE_CONTRACT.md`, `TEST_STRATEGY_CONTRACT.md`, `CHANGE_CONTROL.md`, `PILOT_APPROVAL.md`, `LIFECYCLE_GATE_EVIDENCE.json` e `PROMPT_EVALUATION.md` estão presentes e ligados aos protocolos de produto/processo.
...
8. Confirma que `AGENTS.md` liga para os caminhos corretos de `EXECUTION_CONTRACT.md`, `UPSTREAM_LEARNING.md`, `PRODUCT_EXCELLENCE.md`, `REQUIREMENTS_ENGINEERING_CONTRACT.md`, `VISUAL_SLICE_CONTRACT.md`, `TEST_STRATEGY_CONTRACT.md`, `HELP_AND_ACADEMY.md` quando aplicável, `PRODUCT_DEFINITION.md`, `PRODUCT_QUALITY_BASELINE.md`, `CHANGE_CONTROL.md`, `QUALITY_GATES.md`, `PROCESS_MANIFEST.json` e `PROMPT_EVALUATION.md`, que podem ser lidos a partir da raiz e que instruções específicas não contradizem os protocolos. Quando Claude Code estiver em âmbito, confirma também que `CLAUDE.md` importa `AGENTS.md`.
