...
8. Confirma que `AGENTS.md` liga para os caminhos corretos de `EXECUTION_CONTRACT.md`, `PRODUCT_EXCELLENCE.md`, `PRODUCT_DEFINITION.md`, `PRODUCT_QUALITY_BASELINE.md`, `CHANGE_CONTROL.md`, `QUALITY_GATES.md`, `PROCESS_MANIFEST.json` e `PROMPT_EVALUATION.md`, que podem ser lidos a partir da raiz e que instruções específicas não contradizem os protocolos. Quando Claude Code estiver em âmbito, confirma também que `CLAUDE.md` importa `AGENTS.md`.
