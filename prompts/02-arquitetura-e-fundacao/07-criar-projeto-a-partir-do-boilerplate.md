...
- `PROCESS_MANIFEST.json`, `QUALITY_GATES.md`, `PRODUCT_DEFINITION.md`, `PRODUCT_QUALITY_BASELINE.md`, `CHANGE_CONTROL.md`, `PILOT_APPROVAL.md`, `LIFECYCLE_GATE_EVIDENCE.json` e `PROMPT_EVALUATION.md` estão presentes e ligados aos protocolos de produto/processo.
