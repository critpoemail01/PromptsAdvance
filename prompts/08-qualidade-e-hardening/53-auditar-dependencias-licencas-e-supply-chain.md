...
Apresenta modo, data/fontes da auditoria, matriz, lote aprovado, atualizações/remoções, advisories resolvidos e aceites, registo de temas/assets premium, licenças pendentes para revisão competente, actions/permissões, SBOM, comandos/resultados e riscos residuais.
