...
- Para acesso, exportação, retificação, eliminação ou restrição de dados, usa primeiro o prompt 38 e fornece aqui apenas as rotas/explicações aprovadas.
...
- Placeholders, lacunas jurídicas e dependências do prompt 38 permanecem visíveis.
...
- Apresenta links e explicações aprovadas para pedidos de direitos; a implementação autenticada pertence ao prompt 38.
...
Apresenta artefactos de entrada, páginas/controlos, placeholders, testes, divergências encontradas, dependências do prompt 38 e questões para revisão jurídica.
