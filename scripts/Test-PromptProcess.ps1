...
Require-Pattern 'prompts/01-preparacao-e-definicao/01-descobrir-nova-ideia-de-app.md' '(?s)S. chama a esta valida..o `independente`.*identidade.*separa..o.*evid.ncia' 'O prompt 01 pode declarar independencia sem separacao comprovada.'
Require-Pattern 'prompts/01-preparacao-e-definicao/01-descobrir-nova-ideia-de-app.md' '(?s)autorrevis.o adversarial completa.*nunca a descrevas como.*independente' 'O prompt 01 confunde autorrevisao com validacao independente.'
